...
FunctionsToExport = @('Initialize-RemoteManagement', 'Import-AppPool', 'Import-Site',
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'IIS', 'UrlRewrite', 'Management', 'WebManagement', 'WebDeploy',
            'AppPool', 'Site', 'MSI', 'WinRM'
